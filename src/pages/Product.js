...
function Product() {
  ...
  return (
    <>
      <Navbar searchText={""} />
      {product.title && (
        <div id="product-container" className="flex justify-around px-32">
          <div
          ...
          >
                  ...
                  product.images.map((image, index) => {
                    return (
                      <div
                        ...
                        className={imageIndex !== index ? temp1 : temp2}
                        // style={{
                      ...
                      >
                        <LazyLoadImage
                          src={image}
                          style={{ aspectRatio: 16 / 11, width: 80 }}
            ...
            <div id="product-description" className="text-lg max-w-xl mt-12">
              {product.description}
            </div>
          </div>
          <div
          ...
          >
            <div id="product-cost-container" className="text-5xl flex flex-row">
              <div id="actual-cost" className="text-slate-600 font-bold">
                $
                {Math.ceil(
                  product.price -
              ...
              <div id="cost" className="text-base text-slate-400 font-bold">
                Original Price
              </div>
            </div>
            {product.discountPercentage > 0 && (
              ...
              >
                {product.discountPercentage}% Discount Available with limited
                time offer.
              </div>
            )}
            <div
              id="product-buy"
              className="px-16 py-3 text-slate-800 font-bold bg-slate-200 rounded-md my-8"
            >
              ADD TO CART
            </div>
            <div
            ...
            >
              <div className="opacity-70">
                <FaShoppingCart size={32} color="rgb(30, 41, 59)" />
              </div>
              <div>-</div>
              <div
